  ...
  ({ label, error, helperText, className = '', id, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        {helperText && !error && (
          <p id={`${inputId}-helper`} className="mt-1.5 text-sm text-[var(--color-text-light)]">
            {helperText}
          </p>
        )}
      </div>
  ...
  ({ label, error, helperText, className = '', id, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        {helperText && !error && (
          <p id={`${textareaId}-helper`} className="mt-1.5 text-sm text-[var(--color-text-light)]">
            {helperText}
          </p>
        )}
      </div>
  ...
  ({ label, error, helperText, options, className = '', id, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        {helperText && !error && (
          <p id={`${selectId}-helper`} className="mt-1.5 text-sm text-[var(--color-text-light)]">
            {helperText}
          </p>
        )}
      </div>
